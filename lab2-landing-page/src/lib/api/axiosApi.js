...
export const API_URL_BACKEND = import.meta.env.VITE_API_URL_BACKEND || "http://localhost:3000"; // URL base de la API backend
const AXIOS_TIMEOUT_MS = import.meta.env.VITE_API_TIMEOUT_MS || 10000; // Tiempo de espera para las peticiones Axios (10 segundos por defecto)
